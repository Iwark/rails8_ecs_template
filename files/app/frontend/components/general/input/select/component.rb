  ...
  module Input
    module Select
      class Component < General::Input::Component
        ...
        def select_classes
          classes = %w[w-full py-2.5 min-h-[2.75rem] rounded bg-white appearance-none shadow-xs
                       border border-gray-300 focus:outline-none focus:shadow-xs-focused disabled:opacity-60
                       focus:border-brand-300 group-[.error]:border-semantic-danger group-[.warning]:border-warning-400]
